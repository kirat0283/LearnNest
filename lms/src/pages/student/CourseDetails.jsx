...
const CourseDetails = () => {
  ...
  const {allCourses,calculateRating,
    calculateNoOfLectures,calculateCourseDuration,calculateChapterTime,currency,backendUrl,userData,getToken} = useContext(AppContext)
  ...
  return courseData ?(
    <>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-purple-100 via-purple-50 to-white'>
      ...
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white '>
        ...
        <div className='p-5'>
                    ...
                    <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-purple-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
                    <div className='pt-6'>
                      <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the course ?</p>
                      <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                        <li>Learn once, access forever - with free lifetime updates.</li>
                        <li>Create hands-on projects that boost your portfolio.</li>
                        <li>Download premium resources & reusable code snippets.</li>
                        <li>Test yourself with fun quizzes & practice challenges.</li>
                        <li>Get a professional certificate to power up your career.</li>
                      </ul>
                    </div>
        </div>
      </div>
